...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request payload for creating a menu")
public class MenuCreateRequest {
    ...
    @Schema(description = "Business menu code", example = "USER_MANAGEMENT", requiredMode = Schema.RequiredMode.REQUIRED)
    private String code;

    @NotBlank(message = "error.name.invalid")
    @Size(max = 150, message = "error.name.invalid")
    @Schema(description = "Menu display name", example = "User management", requiredMode = Schema.RequiredMode.REQUIRED)
    private String name;
    ...
    @Schema(description = "Menu type", example = "MENU", requiredMode = Schema.RequiredMode.REQUIRED)
