...
public enum MessageCode {
    ...
    OTP_ATTEMPTS_EXCEEDED("OTP_ATTEMPTS_EXCEEDED", "error.otp.attemptsExceeded"),
    ...
    PASSWORD_ATTEMPTS_EXCEEDED("PASSWORD_ATTEMPTS_EXCEEDED", "error.auth.passwordAttemptsExceeded"),
