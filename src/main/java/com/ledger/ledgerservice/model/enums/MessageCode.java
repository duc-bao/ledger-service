...
public enum MessageCode {
    ...
    CANNOT_DELETE_ACTIVE_USER("CANNOT_DELETE_ACTIVE_USER", "error.user.cannotDeleteActive"),
    ADMIN_PASSWORD_INVALID("ADMIN_PASSWORD_INVALID", "error.user.adminPasswordInvalid"),
    ROLE_HAS_USERS("ROLE_HAS_USERS", "error.role.hasUsers"),
    PASSWORD_RESET_SUCCESS("SUCCESS", "success.user.passwordReset"),
